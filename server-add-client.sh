...
showmount -e $ip_pc; rpcinfo -p $ip_pc
#montaje disco de red en carpeta local
mount ${ip_pc}:/nfs /nfs
df -h
cd /nfs
touch /nfs/sucess-${ip_local}
...
sudo -u mpiuser -H sh -c "mkdir /home/mpiuser/.ssh"
sudo -u mpiuser -H sh -c "cp /nfs/.ssh/id_rsa.pub /home/mpiuser/.ssh"
sudo -u mpiuser -H sh -c "cp /nfs/.ssh/id_rsa /home/mpiuser/.ssh"
#se copia la clave del servidor como clave segura
sudo -u mpiuser -H sh -c "cp /home/mpiuser/.ssh/id_rsa.pub /home/mpiuser/authorized_keys"
